...
import 'package:tech_blog/model/main_data.dart';

Map homePageBannerMap = {
  "image": Assets.images.posterTest.path,
  "writer": "ملیکا قربان نژاد",
  "date": "یک روز پیش",
  "title": "دوازده قدم تا تبدیل شدن به یک برنامه نویس حرفه ای",
  "view": "251",
};
...
List<BlogModel> hottestPostsList = [
  BlogModel(
    id: 1,
    imageUrl:
...
List<HottestPostsStaticImages> hottestPostsStaticImageList = [
  HottestPostsStaticImages(imagePath: Assets.images.mask.path),
  HottestPostsStaticImages(imagePath: Assets.images.apple.path),
  HottestPostsStaticImages(imagePath: Assets.images.mars.path),
  HottestPostsStaticImages(imagePath: Assets.images.butterfly.path),
  HottestPostsStaticImages(imagePath: Assets.images.speaker.path),
];

List<HottestPodcasts> hottestPodcastList = [
  HottestPodcasts(
    id: 1,
    title: "دنیای رنگ",
    imagePath: Assets.images.colorful.path,
  ),
  HottestPodcasts(
    id: 2,
    title: "رادیو کست",
    imagePath: Assets.images.microphone.path,
  ),
  HottestPodcasts(
    id: 3,
    title: "کریسمس",
    imagePath: Assets.images.christmas.path,
  ),
  HottestPodcasts(
    id: 4,
    title: "سرگرمی",
    imagePath: Assets.images.adsense.path,
  ),
  HottestPodcasts(
    id: 5,
    title: "فناوری",
    imagePath: Assets.images.office.path,
  ),
];
