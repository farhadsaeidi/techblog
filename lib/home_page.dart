          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 35),
                // عنوان مشاهده داغ ترین پادکست ها
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 0, 20, 16),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                ...
                // عکس و عنوان زیر عکس مشاهده داغ ترین پادکست ها
                SizedBox(
                  height: screenSize.height / 4.1,
                  child: ListView.builder(
                    itemCount: hottestPodcastsNumber,
                    physics: BouncingScrollPhysics(),
                    scrollDirection: Axis.horizontal,
                    itemBuilder: ((context, index) {
                      return hottestPoscastsItem(index, textTheme, screenSize, hottestPodcastsNumber);
                    }),
                  ),
                ),
              ],
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                        hottestPodcastList[index].imagePath,
                      ),
                      fit: BoxFit.cover,
                    ),
                  ),
